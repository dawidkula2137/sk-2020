...
1. Zamieniamy adres IP oraz maskę na postać binarną
2. na liczbach binarnych wykonujemy operację AND (Mnożenie)
3. Wynik konwertujemy na system dziesiętny

#### Adres rozgłoszeniowy

1. Wyliczamy odwrotność maski (operacja NOT)  
2. Zamieniamy otrzymaną liczbę binarną na postać dziesiętną
3. Liczbę dziesiętną dodajemy do adresu sieci
